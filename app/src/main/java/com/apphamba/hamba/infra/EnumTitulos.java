...
public enum EnumTitulos {
    ...
    ID_TEMPORADA("id_temporada"), NUMERO_EPISODIO("numero_episodio"), TABELA_IMAGEM("titulo_imagem"), TIPO("tipo"), ID_EPISODIO("id_episodio"), TABELA_ASSISTIDO("episodio_assistido");
